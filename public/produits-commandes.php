        ...
        <div class="row g-3 mb-4">
          ...
          <div class="col-sm-6 col-md-3">
            <div class="card bg-primary-subtle border-0 h-100">
              ...
              <div class="card-footer bg-transparent border-0 pt-0 pb-3 mt-n2">
                <a class="position-relative d-inline-flex align-items-center fs-sm fw-medium text-primary text-decoration-none" href="#!">
                  <span class="hover-effect-underline stretched-link">Voir toutes</span>
            ...
            <div class="card bg-success-subtle border-0 h-100">
              ...
              <div class="card-footer bg-transparent border-0 pt-0 pb-3 mt-n2">
                <a class="position-relative d-inline-flex align-items-center fs-sm fw-medium text-success text-decoration-none" href="#!">
                  <span class="hover-effect-underline stretched-link">Voir livrées</span>
                  <i class="fi-chevron-right fs-base ms-1"></i>
                </a>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-md-3">
            <div class="card bg-warning-subtle border-0 h-100">
              ...
              <div class="card-footer bg-transparent border-0 pt-0 pb-3 mt-n2">
                <a class="position-relative d-inline-flex align-items-center fs-sm fw-medium text-warning text-decoration-none" href="#!">
                  <span class="hover-effect-underline stretched-link">Suivre</span>
                  <i class="fi-chevron-right fs-base ms-1"></i>
                </a>
              </div>
            </div>
          ...
          <div class="col-sm-6 col-md-3">
            <div class="card bg-info-subtle border-0 h-100">
              ...
              <div class="card-footer bg-transparent border-0 pt-0 pb-3 mt-n2">
                <a class="position-relative d-inline-flex align-items-center fs-sm fw-medium text-info text-decoration-none" href="#!">
                  <span class="hover-effect-underline stretched-link">Détails</span>
                  <i class="fi-chevron-right fs-base ms-1"></i>
                </a>
              </div>
            </div>
  ...
  <div class="col">
    <article class="card h-100 border hover-effect-scale">
      ...
      <div class="card-body p-4">
        ...
        <!-- Produits de la commande (2 par ligne) -->
    ...
    <article class="card h-100 border hover-effect-scale">
      <div class="card-header bg-transparent py-3">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
          <div class="mb-2 mb-md-0">
            <div class="d-flex align-items-center flex-wrap gap-2">
              <span class="badge bg-info bg-opacity-10 text-info border border-info border-opacity-25">Expédiée</span>
              <span class="fw-semibold">#SAL-2024-0130</span>
            </div>
            <div class="fs-sm text-body-secondary mt-1">28/10/2024 • En transit</div>
          </div>
          <div class="text-md-end">
            <div class="h5 mb-1">214,70€</div>
            <div class="fs-sm text-body-secondary">4 articles</div>
          </div>
        </div>
      </div>
      <div class="card-body p-4">
        ...
        <div class="mb-3 pb-3 border-bottom">
          <div class="d-flex align-items-center gap-2 fs-sm">
            <i class="fi-truck text-body-secondary"></i>
            <span class="fw-semibold">Livraison express</span>
            <span class="text-body-secondary ms-2">• Livraison 24h</span>
          </div>
        </div>
        ...
        <div class="row row-cols-2 g-3 mb-4">
          <div class="col">
            <div class="d-flex gap-2 align-items-start">
              <div class="flex-shrink-0 position-relative">
                <img src="https://images.unsplash.com/photo-1581092580497-e0d4cb184827?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80" 
                     class="rounded" width="50" height="50" alt="Meuleuse d'angle">
                <div class="position-absolute top-0 end-0 translate-middle badge bg-primary rounded-circle p-1" style="width: 20px; height: 20px; font-size: 10px;">
                  1
                </div>
              </div>
              <div class="flex-grow-1">
                <h6 class="fs-sm mb-1">Meuleuse 125mm</h6>
                <div class="d-flex justify-content-between align-items-center">
                  <span class="text-body-secondary fs-xs">Commande n°1</span>
                  <span class="fw-semibold fs-sm">74,90€</span>
                </div>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="d-flex gap-2 align-items-start">
              ...
              <div class="flex-grow-1">
                <h6 class="fs-sm mb-1">Perceuse 18V</h6>
                <div class="d-flex justify-content-between align-items-center">
                  <span class="text-body-secondary fs-xs">Commande n°2</span>
                  <span class="fw-semibold fs-sm">89,90€</span>
                </div>
          ...
          <div class="col">
            <div class="d-flex gap-2 align-items-start">
              ...
              <div class="flex-grow-1">
                <h6 class="fs-sm mb-1">Peinture Blanche</h6>
                <div class="d-flex justify-content-between align-items-center">
                  <span class="text-body-secondary fs-xs">Commande n°2</span>
                  <span class="fw-semibold fs-sm">27,60€</span>
                </div>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="d-flex gap-2 align-items-start">
              <div class="flex-shrink-0 position-relative">
                <img src="https://images.unsplash.com/photo-1581093451466-3c30452d61a8?ixlib=rb-4.0.3&auto=format&fit=crop&w=150&q=80" 
                     class="rounded" width="50" height="50" alt="Gants">
                <div class="position-absolute top-0 end-0 translate-middle badge bg-primary rounded-circle p-1" style="width: 20px; height: 20px; font-size: 10px;">
                  2
                </div>
              </div>
              <div class="flex-grow-1">
                <h6 class="fs-sm mb-1">Gants Protection</h6>
                <div class="d-flex justify-content-between align-items-center">
                  <span class="text-body-secondary fs-xs">Commande n°2</span>
                  <span class="fw-semibold fs-sm">22,30€</span>
                </div>
              </div>
            </div>
          </div>
